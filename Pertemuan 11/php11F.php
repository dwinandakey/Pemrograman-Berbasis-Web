...
<body>
            ...
            <tbody>
                ...
                try {
                    ...
                    while ($row = $stmt->fetch()) {
                        ...
                        <a href='php11G.php?slot=", $row["slot"], "' class='editButton'><img src='edit.png' alt='Edit'></a>
                        <a href='php11H.php?slot=", $row["slot"], "' class='deleteButton'><img src='delete.png' alt='Delete'></a>
                        </td>
                        </tr>";
                    }
                    // Menutup koneksi PDO
    ...
    <br>
    <a id="newData" href="php11E.php">Tambah</a>
    <br>
